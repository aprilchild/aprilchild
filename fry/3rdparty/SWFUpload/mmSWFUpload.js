...
mmSWFUpload = {
	...
	init: function(settings) {
		...
		// Create SWFObject
		var so = new SWFObject('?/SWFUpload/upload.swf'.embed(settings.thirdPartyPath), "_mmSWFUploadField", "1px", "1px", this.addSetting("flash_version", "8"), "#000000");
//		var so = new SWFObject("jscripts/SWFUpload/upload.swf", "_mmSWFUploadField", "1px", "1px", this.addSetting("flash_version", "8"), "#000000");
	...
	callSWF: function() {
		...
		{
			var type_of = typeof mmSWFUpload.getMovie('_mmSWFUploadField');
			if ( ('function' == type_of || 'object' == type_of) && mmSWFUpload.getMovie('_mmSWFUploadField').uploadImage )
			{
