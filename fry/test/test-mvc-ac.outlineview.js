...
// error occured when loading contents of container, let's display alert message
ExampleView.prototype.renderElementLoadError = function(listContainer, error, node)
{
	alertUser('An error occured', 'Error while loading contents of <strong>?</strong>.<p>Message: ?</p>'.embed(listContainer.properties.label, error), function(){});
}
